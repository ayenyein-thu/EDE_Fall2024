...
data_source <- 'https://services1.arcgis.com/Hp6G80Pky0om7QvQ/arcgis/rest/services/Plants_gdb/FeatureServer/0/query?outFields=*&where=1%3D1&f=geojson'

powerplants <- st_read(data_source) %>% 
  filter(STATE=="NC")
