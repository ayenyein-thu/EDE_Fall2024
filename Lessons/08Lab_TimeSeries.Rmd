...
plot1 <- ggplot(BR_complete,aes(x=Date,y=Rainfall)) +
  geom_line() + 
  geom_smooth(method=lm) +
  ylab("Rainfall")
print(plot1)

plot2 <- ggplot(BR_complete,aes(x=Date,y=Temperature_C)) +
  geom_line() + 
  geom_smooth(method=lm) +
  ylab("Temperature C")
print(plot2)
...
BR_Timeseries1 <- ts(BR_complete$Rainfall,
                    start=c(f_year,f_month),
                    frequency=12)
BR_Timeseries1

BR_Timeseries2 <- ts(BR_complete$Temperature_C,
                    start=c(f_year,f_month),
                    frequency=12)
```
...
BR_Decomp1 <- stl(BR_Timeseries1, s.window="periodic")
plot(BR_Decomp1)

BR_Decomp2 <- stl(BR_Timeseries2, s.window="periodic")
plot(BR_Decomp2)
