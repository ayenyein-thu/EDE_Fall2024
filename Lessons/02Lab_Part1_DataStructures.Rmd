...
# Combine the elements in vector 1 and vector 4
c(vector1, vector4)

# Multiply elements by elements of vector 1 and vector 4
vector1 * vector4

# Multiply all the elements by 10
vector1 * 10

# Convert elements to upper cases
toupper(vector2) 

#  Create the opposite of vector 3
!vector3
...
matrix1[4, 1] # Get the element in 4th row and 1st column

matrix1[4,  ] # Get all the elements in 4th row

matrix1[ , 3] # Get all the elements in 3rd column 

matrix1[c(12, 14)] # Get the specific elements and check the position

matrix1[c(12:14)] # Get the elements between 12 and 14

matrix1[2:4, 1:3] # Get the rows 2 to 4 and columns 1 to 3 
...
# Age elements in the list
list1$age

# Names of all the objects in the list
names(list1)

# The first two objects of the list
list1[1:2]

# Change the value of the object 
list1$name = "Janelle"

# Get the value of the 4th object, not including the object names
list1[[4]] = 44
```
